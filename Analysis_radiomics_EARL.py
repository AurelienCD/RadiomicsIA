...
df = pad.read_excel('//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/AnalyseRadiomic-EARL_17032021.xlsx', header=0)
...
for i in range(118): 
	...
	if results[1] < 0.05:
		...
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Toutes loc/t-test__" + str(df.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] > 0.05:
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Toutes loc/PAS SIGNIFICATIF/t-test__" + str(df.columns[y]), dpi=400)
		#figure.savefig("C:/Users/corrau/Documents/Etude IA Radiomics TEP/Figures_ttest_Origin_IA/toutes_loc/t-test__" + str(df.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] < 0.05:
		...
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Liver/t-test__" + str(df_liver.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] > 0.05:
		ax = sns.boxplot(x='Groupe', y=df_liver[df_liver.columns[y]], data=df_liver, showfliers = False) 
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Liver/PAS SIGNIFICATIF/t-test__" + str(df_liver.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] < 0.05:
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Lung/t-test__" + str(df_Lung.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] > 0.05:
		ax = sns.boxplot(x='Groupe', y=df_Lung[df_Lung.columns[y]], data=df_Lung, showfliers = False) 
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Lung/PAS SIGNIFICATIF/t-test__" + str(df_Lung.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] > 0.05:
		ax = sns.boxplot(x='Groupe', y=df_Muscle[df_Muscle.columns[y]], data=df_Muscle, showfliers = False) 
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Muscle/PAS SIGNIFICATIF/t-test__" + str(df_Muscle.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] < 0.05:
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/BloodPool/t-test__" + str(df_BloodPool.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] > 0.05:
		ax = sns.boxplot(x='Groupe', y=df_BloodPool[df_BloodPool.columns[y]], data=df_BloodPool, showfliers = False) 
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/BloodPool/PAS SIGNIFICATIF/t-test__" + str(df_BloodPool.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] < 0.05:
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Lesion/t-test__" + str(df_Lesion.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] > 0.05:
		ax = sns.boxplot(x='Groupe', y=df_Lesion[df_Lesion.columns[y]], data=df_Lesion, showfliers = False)
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_Analyse_Stat/Lesion/PAS SIGNIFICATIF/t-test__" + str(df_Lesion.columns[y]), dpi=400)
...
for i in range(118): 
	...
	if results[1] < 0.05:
		...
		ax.text(0.05, 0.9, "R²=" + str(round(results[0]*results[0],3)), horizontalalignment='left', verticalalignment='top', transform=ax.transAxes)
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_stabilité_radiomics_liver/Effet_algo__" + str(df_liver.columns[y]), dpi=400)
		print("Pour la variable " + str(df.columns[y] + " la valeur de p est inférieur à 0.05, et R² est égal à : " + str(round(results[0]*results[0],3))))
	figure.clear()
	y+=1
### Liver ###
...
for i in range(118): 
	...
	if results[1] < 0.05:
		...
		ax.text(0.05, 0.9, "R²=" + str(round(results[0]*results[0],3)), horizontalalignment='left', verticalalignment='top', transform=ax.transAxes)
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_stabilité_radiomics_lung/Effet_algo__" + str(df_Lung.columns[y]), dpi=400)
		print("Pour la variable " + str(df.columns[y] + " la valeur de p est inférieur à 0.05, et R² est égal à : " + str(round(results[0]*results[0],3))))
	figure.clear()
	y+=1
### Lung ###
...
for i in range(118): 
	...
	if results[1] < 0.05:
		...
		ax.text(0.05, 0.9, "R²=" + str(round(results[0]*results[0],3)), horizontalalignment='left', verticalalignment='top', transform=ax.transAxes)
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_stabilité_radiomics_muscle/Effet_algo__" + str(df_Muscle.columns[y]), dpi=400)
		print("Pour la variable " + str(df.columns[y] + " la valeur de p est inférieur à 0.05, et R² est égal à : " + str(round(results[0]*results[0],3))))
	figure.clear()
	y+=1
### Muscle ###
...
for i in range(118): 
	...
	if results[1] < 0.05:
		...
		ax.text(0.05, 0.9, "R²=" + str(round(results[0]*results[0],3)), horizontalalignment='left', verticalalignment='top', transform=ax.transAxes)
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_stabilité_radiomics_lesion/Effet_algo__" + str(df_Lesion.columns[y]), dpi=400)
		print("Pour la variable " + str(df.columns[y] + " la valeur de p est inférieur à 0.05, et R² est égal à : " + str(round(results[0]*results[0],3))))
	figure.clear()
	y+=1
### Lesion ###
...
for i in range(118): 
	...
	if results[1] < 0.05:
		...
		ax.text(0.05, 0.9, "R²=" + str(round(results[0]*results[0],3)), horizontalalignment='left', verticalalignment='top', transform=ax.transAxes)
		figure = ax.get_figure()
		figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Figures_stabilité_radiomics_bloodpool/Effet_algo__" + str(df_BloodPool.columns[y]), dpi=400)
		print("Pour la variable " + str(df.columns[y] + " la valeur de p est inférieur à 0.05, et R² est égal à : " + str(round(results[0]*results[0],3))))
	figure.clear()
	y+=1
### BloodPool ###
...
def saveCCCRadiomicClass(CCC, Featurs, Class, Loc):
	...
	ax.set_title(Class)
	figure = ax.get_figure()
	figure.savefig("//s-grp/grp/RADIOPHY/Personnel/Aurélien Corroyer-Dulmont/Recherche/AI TEP SubtleMedical/article front oncol noise IA/Analyse 64bins/CCC_IA/"+ str(Loc) + "/CCC_" + str(Loc) + str(Class), dpi=400, bbox_inches='tight')
	plt.show()
